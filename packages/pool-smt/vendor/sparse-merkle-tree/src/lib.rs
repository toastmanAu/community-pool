...
// `blake2b` module removed in this vendored copy — it required the
// `blake2b-rs` C dep which does not compile to wasm32-unknown-unknown.
// Consumers provide their own Hasher impl (e.g. blake2b_simd).
#[cfg(feature = "smtc")]
pub mod ckb_smt;
